# Contributing to `vwifi`

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to [vwifi](https://github.com/sysprog21/vwifi)
...
Visit our [Issues page on GitHub](https://github.com/sysprog21/vwifi/issues) to search and submit.
